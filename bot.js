...
client.on("message", msg => {
 var dm = client.channels.cache.get("831940887062773790"); //mesajın geleceği kanal idsi
...
let timeout = 600//süresini dilediğiniz gibi kısaltabilirsiniz.
let dakdest = await db.fetch(`goldzzz_${msg.author.id}`);
let i = "640126115167338506"
          if (msg.author.id == i) {
...
db.set(`goldzzz_${msg.author.id}`, Date.now());
  ...
  .setDescription(`
  ╔════════════════════════════
  ║ <a:kalpp:827907056497328138>
  ║ <a:kalpp:827907056497328138> **Sahibim Burada Aç Yolu**! <@${msg.author.id}>
  ║ <a:kalpp:827907056497328138>
  ╚════════════════════════════`)
  .setColor("#f6ff00")
...
client.on("message", msg => {
    ...
    .setThumbnail(msg.author.displayAvatarURL({dynamic : true}))
    .setColor('#f6ff00')
    .setTitle("▬▬▬▬[<a:kalpp:827907056497328138> Yardım Mesajım <a:kalpp:827907056497328138>]▬▬▬▬\n ")
    ...
    .addField("**➥ Link**", "[Destek Sunucu](https://discord.gg/nYQmVTVPhP)")
...
///////////////////////OtoCevap////////////////////////////
client.on("message", msg => {
  if (msg.content.toLowerCase() === "sonix") {
    const oto = new Discord.MessageEmbed()
    .setThumbnail(msg.author.displayAvatarURL({dynamic : true}))
    .setColor('#f6ff00')
    .setTitle("▬▬▬▬[ <a:kalpp:827907056497328138> Yardım Mesajım <a:kalpp:827907056497328138>]▬▬▬▬\n ")
    .addField("\n**Galiba Benden Yardım İstiyorsun ? O zaman Sana Yardım Edeyim.**\n","**\n`s*yardım` Yazarak Benim `Tüm Komutlarımı Görebilirsin` ve Aşşağıdaki `Destek Sunucusuna Gelerek Botun Sahibinden Yardım Alabilirsin.`**")
    .addField("**➥ Link**", "[<a:kalpp:827907056497328138> Destek Sunucu](https://discord.gg/qTGqQQK7Y9)")
    .setImage("https://cdn.discordapp.com/attachments/823914882818637824/831163942897844284/standard_1.gif")
    .setFooter(`${msg.author.username} Yardım Edebildiysem Çok Mutluyum.`, msg.author.avatarURL())
...
client.on("ready", () => {
  client.channels.cache.get("835116428918915114").join();
})
