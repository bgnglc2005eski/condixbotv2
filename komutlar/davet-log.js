...
.setThumbnail(message.author.displayAvatarURL({dynamic : true}))
  ...
  .addField('İşte Destek Sunucum',"[Destek Sunucusu](https://discord.gg/NwxxUS9sMP)")
  .setFooter('Üzgünüm...')
...
if(message.author.id != "477189482206986240") return message.channel.send(bakim)
 ...
 if (!message.member.hasPermission('ADMINISTRATOR'))
        return message.channel.send('<a:guvenlikk:827113437150052376> **Bu komutu kullanabilmek için `Yönetici` yetkisine sahip olmalısın! **')
...
if (args[0] === 'sıfırla') {
  ...
  if (!seviyelog) return message.channel.send(`<a:guvenlikk:827113437150052376> Davet Logu Zaten Ayarlanmadığı İçin Sıfırlanamaz! `)
...
if(!kanal) return message.channel.send(`<a:guvenlikk:827113437150052376> | **Davet Logu Belirtmelisin!** `)
