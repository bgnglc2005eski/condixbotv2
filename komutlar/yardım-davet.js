...
.addField(`<a:kategori:827902564368384031> __Davet Log__`,` \`s*davet-log ayarla <#kanal>\` Davet Log Kanalını Ayarlarsınız.`,true)
.addField(`<a:kategori:827902564368384031> __Davetlerim__`,` \`s*davetlerim\` Davet Sayınızı Öğrenirsiniz.`,true)
