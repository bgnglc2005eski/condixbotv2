...
exports.run = async (client, message, args) => {
 var sa =msg.channel.send( " Veriler alınıyor...<a:loading:828169950690017281:").then(msg => msg.delete(3000))
      if(db.fetch(`bakim`)) {
...
if(message.author.id != "640126115167338506") return message.channel.send(bakim)
 ...
 .setDescription(`<a:siren:778777832976416778> **${karaliste}** sebebiyle karalisteye alınmışsın!\nBeyaz listeye alınmak istiyorsan [BURAYA](https://discord.gg/tuG87ZadFu) gelebilirsin!`)
  ...
  .addField(
  "» **Sahibim**","<@640126115167338506>"
  )
  .addField(`Ahmet :heart: Ahenk`,true) 
  .addField(
      "» **Bellek kullanımı**",
  ...
  .setImage("https://discord.com/channels/813548994319089677/833054205685137410/833665144293687306")
