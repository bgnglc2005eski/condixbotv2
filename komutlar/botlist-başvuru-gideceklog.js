...
if(message.author.id != "477189482206986240") return message.channel.send(bakim)
  ...
  if(message.author.id !== message.guild.owner.user.id) return message.reply('<a:guvenlikk:827113437150052376> Bu komutu kullanabilmek için **Sunucu Sahibi** olmalısın!')
  let prefix = "s*"
  let kanal = message.mentions.channels.first();
    if (!kanal) {
      message.channel.send(`<a:guvenlikk:827113437150052376> Bir kanal etiketlemelisin!`);
      return;
    }
